...
if __name__ == "__main__":
    ...
    # 2) Load precomputed sponsor-safe split
    ...
    # 3) Model
    input_dim = X.shape[2]  # 9 features: [phase_enc, enroll_z, gap_months, ...trends...]
    model = SponsorRiskGRU(input_dim=input_dim, hidden_dim=64, num_layers=1, dropout=0.1)

    # 4) DataLoaders (stable)
    ...
    # 5) Loss (class-weighted BCE with device-safe pos_weight)
